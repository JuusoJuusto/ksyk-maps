    ...
    <div className={`min-h-screen ${darkMode ? 'bg-gray-900' : 'bg-blue-50'}`}>
      ...
      <div className="flex h-[calc(100vh-4rem)] relative overflow-hidden justify-center">
        ...
        `}>
          ...
          {/* Navigation Button */}
          <div className={`px-3 py-2 md:p-4 border-b ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
            <Button
              onClick={() => setNavigationOpen(true)}
              className="w-full bg-white hover:bg-gray-50 text-blue-600 border-2 border-blue-500 h-11 md:h-14 text-sm md:text-lg font-bold shadow-lg hover:shadow-xl transition-all"
            >
          ...
          <div className={`px-3 py-2 md:p-4 border-b ${darkMode ? 'border-gray-700 bg-gray-800/50' : 'border-gray-200 bg-blue-50/50'}`}>
            ...
            {searchResults.length > 0 && (
              <div className={`mt-2 max-h-48 md:max-h-64 overflow-y-auto border-2 rounded-xl shadow-lg ${darkMode ? 'border-gray-600 bg-gray-700' : 'border-blue-200 bg-white'}`}>
        ...
        <div className={`flex-1 relative ${darkMode ? 'bg-gray-900' : 'bg-white'}`}>
          ...
          {activeTab === 'map' && (
            <div className="h-full">
              ...
              <div className={`h-full p-0 overflow-hidden relative ${darkMode ? 'bg-gray-900' : 'bg-white'}`}>
                ...
                >
                <svg viewBox="0 0 10000 6000" className="w-full h-full" preserveAspectRatio="xMidYMid meet" style={{ minWidth: '100%', minHeight: '100%' }}>
          ...
          {activeTab === 'settings' && (
            <div className="h-full overflow-auto">
              <div className={`${darkMode ? 'bg-gray-900' : 'bg-gray-50'} p-4 md:p-8`}>
                {/* Empty space at top to avoid overlap with tabs */}
